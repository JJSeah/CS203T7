...
//        String token = generateBearerToken(new HashMap<>());
        ...
        ResponseEntity<Card> responseEntity = restTemplate.exchange("/api/card/999", HttpMethod.GET, requestEntity, Card.class);
...
//                "/api/card/add/" + userRepository.findUserByEmail("Admin@gmail.com").getId(), HttpMethod.POST, requestEntity, Card.class);
//
